CLASS lsc_zey_aaa_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zey_aaa_travel IMPLEMENTATION.
   ...
   IF update-travel IS NOT INITIAL.
     ...
     LOOP AT update-travel ASSIGNING FIELD-SYMBOL(<travel_log_update>).
       ...
       IF <travel_log_update>-%control-CustomerId = if_abap_behv=>mk-on.
         ...
         <travel_log_db>-changed_field_name = 'akhil_customer'.
       ...
       IF <travel_log_update>-%control-AgencyId = if_abap_behv=>mk-on.
         <travel_log_db>-change_id = cl_system_uuid=>create_uuid_x16_static( ).
         <travel_log_db>-changed_field_name = 'akhil_agency'.
...
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    types:  t_entity_create type table for create zey_aaa_travel,
            t_entity_update TYPE table for update zey_aaa_travel,
            t_entity_rep type table for REPORTED zey_aaa_travel,
            t_entity_err type table for FAILED zey_aaa_travel.

    methods precheck_akhil_reuse
        importing
...
*            ENDIF.
  ...
  data: entity type STRUCTURE FOR CREATE zey_aaa_travel,
...
*        CATCH cx_number_ranges.
  ...
  data: travels type table for create zey_aaa_travel\\Travel,
         bookings_cba type table for create zey_aaa_travel\\Travel\_Booking,
         booksuppl_cba type table for create zey_aaa_travel\\Booking\_BookingSupplement.
   ...
   MODIFY ENTITIES OF zey_aaa_travel IN LOCAL MODE
       ENTITY travel
