CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
 PRIVATE SECTION.
   types: tt_travel_failed TYPE table for failed ZEY_AAA_U_TRAVEL,
            tt_travel_reported type table for REPORTED ZEY_AAA_U_TRAVEL.
...
*          et_messages            =
 ...
 ENDMETHOD.
ENDCLASS.
CLASS lsc_ZEY_AAA_U_TRAVEL DEFINITION INHERITING FROM cl_abap_behavior_saver.
 PROTECTED SECTION.
...
ENDCLASS.
CLASS lsc_ZEY_AAA_U_TRAVEL IMPLEMENTATION.
 METHOD finalize.
 ENDMETHOD.
