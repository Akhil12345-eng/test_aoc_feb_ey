CLASS zcl_ey_aaa_ve_calc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_EY_AAA_VE_CALC IMPLEMENTATION.


  METHOD if_sadl_exit_calc_element_read~calculate.
check not it_original_data is initial.
   data: lt_calc_data type standard table of zey_aaa_travel_processor with DEFAULT KEY,
